...
// import video from './../../assets/videos/guessWhere.mp4'
...
export default function GuessWhere() {
    return (
        <div className='pb-20 relative'>
            ...
            >
                <h1 className="text-3xl md:text-4xl font-bold">GuessWhere</h1>
                <div className="relative h-80 bg-white overflow-hidden">
                    {/* <video src={video} className="w-full h-full" autoPlay muted loop></video> */}
                    <div className="video_fix absolute top-0 left-0 w-full  bg-white"></div>
                    <div className="video_fix absolute bottom-0 left-0 w-full  bg-white"></div>
                </div>
            </section>
