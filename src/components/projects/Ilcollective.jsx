...
export default function Ilcollective() {
    return (
        <div className='pb-20 relative'>
            ...
            >
                <h1 className="text-3xl md:text-4xl font-bold">IlCollective</h1>
            ...
            {/* 
            <div className="grid xl:grid-cols-5 xl:grid-rows-6 grid-cols-1 gap-4 relative top-38 left-1/2 -translate-x-1/2 gallery pb-20">
