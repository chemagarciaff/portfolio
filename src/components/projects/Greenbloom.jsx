    ...
    return (
        <div className='pb-20 relative'>
            ...
            <div className="grid grid-cols-9 grid-rows-6 gap-4  relative top-30 pb-30">
                <img src={img1} className="border-1 border-gray-500 col-span-6 row-span-4"/>
                <img src={img4} className="border-1 border-gray-500 col-span-3 row-span-2 col-start-7"/>
                <img src={img3} className="border-1 border-gray-500 col-span-3 row-span-2 col-start-7 row-start-3"/>
                <img src={img2} className="border-1 border-gray-500 col-span-3 row-span-2 row-start-5"/>
                <img src={img6} className="border-1 border-gray-500 col-span-3 row-span-2 col-start-4 row-start-5"/>
                <img src={img5} className="border-1 border-gray-500 col-span-3 row-span-2 col-start-7 row-start-5"/>
            </div>
        </div>
    );
}
